...
from utilities.utilities import write_push_data_payload
import argparse
import logging
...
def main(args):
    ...
    The main function.
    """
    filename = write_push_data_payload(args.business_class)

    logging.info(f'Wrote push data payload to {filename}')
